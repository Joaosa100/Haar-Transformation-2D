...
# diferencas = compararPGMs(img1, img2, 0, pgm_comparacao)
...
#     return diferencas, quantidade_dif
...
# tolerancia = 0
# diferencas, quantidade_dif = compararPGMs(img1, img2, tolerancia, pgm_comparacao)
...
#     info_text = f"Quantidade de pixels diferentes: {quantidade_dif} \nCom margem de erro de {tolerancia}"
#     plt.gcf().text(0.5, 0.01, info_text, fontsize=10, ha='center', va='bottom')
